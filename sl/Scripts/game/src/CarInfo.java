		...
		*/
		...
		if (error_text)
			...
			if (dyno)
			{
				...
				osd.createText( "Max Torque = " + Float.toString(dyno.maxTorque*0.7353, "%1.2f lb-ft / ") + Float.toString(dyno.maxTorque, "%1.2f Nm"), Frontend.smallFont, Text.ALIGN_LEFT, -0.07, -0.55, 0);
				osd.createText( "Max Power = " + Float.toString((((dyno.getTorque(dyno.RPM_maxHP, 0.0) * 0.7376)*dyno.RPM_maxHP)/5252.0), "%1.2f HP / ") + Float.toString((((dyno.getTorque(dyno.RPM_maxHP, 0.0) * 0.7376)*dyno.RPM_maxHP)/5252.0*0.7457), "%1.2f Kw"), Frontend.smallFont, Text.ALIGN_LEFT, -0.07, -0.50, 0);
